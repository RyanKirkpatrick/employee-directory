(function () {
	...
	edCreateEmployeeCtrl.$inject = ['edNotifierService', 'edEmployeeService', 'edDeskService', 'edSidebarService'];

	function edCreateEmployeeCtrl(edNotifierService, edEmployeeService, edDeskService, edSidebarService) {
		var vm = this;
